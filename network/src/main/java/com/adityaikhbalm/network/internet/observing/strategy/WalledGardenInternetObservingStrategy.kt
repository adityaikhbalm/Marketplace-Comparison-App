package com.adityaikhbalm.network.internet.observing.strategy

import com.adityaikhbalm.network.Preconditions
...
import com.adityaikhbalm.network.tickerFlow
...
class WalledGardenInternetObservingStrategy : InternetObservingStrategy {
    ...
    override fun observeInternetConnectivity(
        ...
        return tickerFlow(period = intervalInMs.toLong(), initialDelay = initialIntervalInMs.toLong()).map {
            isConnected(
                adjustedHost,
                port,
                timeoutInMs,
