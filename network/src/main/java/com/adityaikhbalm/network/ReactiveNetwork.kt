package com.adityaikhbalm.network

import android.Manifest
import android.content.Context
import androidx.annotation.RequiresPermission
import com.adityaikhbalm.network.internet.observing.InternetObservingSettings
import com.adityaikhbalm.network.internet.observing.InternetObservingStrategy
import com.adityaikhbalm.network.internet.observing.error.ErrorHandler
import com.adityaikhbalm.network.network.observing.NetworkObservingStrategy
import com.adityaikhbalm.network.network.observing.strategy.LollipopNetworkObservingStrategy
import com.adityaikhbalm.network.network.observing.strategy.MarshmallowNetworkObservingStrategy
...
object ReactiveNetwork {
    ...
    fun observeNetworkConnectivity(context: Context): Flow<Connectivity> {
        val strategy: NetworkObservingStrategy =
            ...
            else LollipopNetworkObservingStrategy()
     ...
     * strategies [LollipopNetworkObservingStrategy] or create your own custom strategy
     * @return Flow with Connectivity class containing information about network state,
     * type and typeName
     */
    @RequiresPermission(Manifest.permission.ACCESS_NETWORK_STATE)
